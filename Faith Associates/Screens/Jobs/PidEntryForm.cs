...
namespace Faith_Associates.Screens.Jobs
{
    public partial class PidEntryForm : TemplateForm
    {
        ...
        private object GetObjects()
        {
            ...
            j.DeliveryCharges = Convert.ToInt32(txtDO.Text);
            j.Wharfage = Convert.ToInt32(txtWhrfage.Text);
            j.ContainerDeposit = Convert.ToInt32(txtContainetDeposit.Text);
            j.LoloCharges = Convert.ToInt32(txtLoloCharges.Text);
            j.PSQCA1 = Convert.ToInt32(txtPSQCA1.Text);
            j.PSQCA2 = Convert.ToInt32(txtPSQCA2.Text);
