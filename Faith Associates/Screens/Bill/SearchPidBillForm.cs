...
{
    public partial class SearchPidBillForm : TemplateForm
    {
        ...
        private void SearchJobs()
        {
            ...
            para.Value = billNo;
            ListData.LoadDataIntoDataGridView(dgvJobList, "usp_PidBillsGetPidBillByBillNo", para);
            ...
            dgvJobList.Columns["PidID"].Visible = false;
        }
        ...
        private void dgvJobList_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            PidID = (int)dgvJobList.Rows[rowIndex].Cells["PidID"].Value;
